...
export default function Home() {
  ...
  const openUnit = (index: number) => { const saved = progressByUnit[index]; setUnitIndex(index); setQuestionIndex(saved?.questionIndex ?? 0); setAnswers(saved?.answers ?? {}); setSubmittedQuestions(saved?.submittedQuestions ?? {}); setView("practice"); };
