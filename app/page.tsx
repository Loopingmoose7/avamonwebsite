...
export default function Home() {
  ...
  const openUnit = (index: number) => { setUnitIndex(index); setQuestionIndex(0); setAnswers({}); setSubmittedQuestions({}); setView("practice"); };
  const goToQuestion = (index: number) => setQuestionIndex(index);
